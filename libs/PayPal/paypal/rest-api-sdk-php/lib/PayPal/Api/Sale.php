...
class Sale extends PayPalResourceModel
{
    ...
    /**
     * Refund a completed payment by passing the sale_id in the request URI. In addition, require_once an empty JSON payload in the request body for a full refund. For a partial refund, require_once an amount object in the request body.
     *
     * @param Refund $refund
     * @param ApiContext $apiContext is the APIContext for this call. It can be used to pass dynamic configuration and credentials.
     * @param PayPalRestCall $restCall is the Rest Call Service that is used to make rest calls
