    ...
    <div class="col-md-12">
        <div class="widget item-text" id="coupon-<?php echo $item->ID; ?>">
            ...
            <div class="info">
                ...
                <?php } else { ?>
                    <div class="code-text">
                        <a href="<?php echo get_target_link( 'coupon', $item->ID, array( 'reveal_code' => true, 'backTo' => $item->link ) ); ?>" target="_blank" class="butt" data-target-on-click="<?php echo get_target_link( 'coupon', $item->ID ); ?>"><?php te( 'theme_show_code', 'Show coupon code' ); ?></a>
                    </div>
                <?php } ?>
                </div>
                </div>
