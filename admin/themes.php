...
<div class="twocols">
    ...
    <div>
        <a href="?route=themes.php&amp;action=menus&amp;do=reset&amp;token=' . $csrf . '">' . t( 'themes_menu_reset_default', 'Reset to default menu' ) . '</a>
    </div>
</div>
...
if( $page > 1 )echo '<a href="?route=themes.php&amp;action=list&amp;page=' . ($page-1) . '" class="btn">' . t( 'prev_page', "� Prev" ) . '</a>';
if( $pages > $page )echo '<a href="?route=themes.php&amp;action=list&amp;page=' . ($page+1) . '" class="btn">' . t( 'next_page', "Next �" ) . '</a>';
echo '</div>';
}
