...
public function default_store_fields( $info = object, $csrf = '' ) {
    ...
    $fields['network']['markup'] = '<div class="row"><span>' . t( 'form_network', "Network" ) . ':</span><div><input type="text" name="network" id="network"/></input><label for="popular"></label></div></div>';
