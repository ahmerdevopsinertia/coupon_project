...
echo '<div class="idashbtm">' . sprintf( t( 'operatesfrom', "Operates from %s" ), date('m/d/Y', \query\main::get_option( 'siteinstalled' )) ) . ' / <a href="//xxcoupons.com" target="_blank" style="color: #000;">xxcoupons.com</a></div>';
