...
require_once DIR . '/' . LBDIR . '/google-api-php-client-master/autoload.php';
...
if( isset( $token_data ) ) {
    ...
    $session = \user\main::insert_user( array( 'username' => $me['displayName'], 'email' => $me['emails'][0]['value'] ), true, true );
