...
class Order extends PayPalResourceModel
{
    ...
    /**
     * Capture a payment on an order by passing the order_id in the request URI. In addition, require_once the amount of the payment and indicate whether this is a final capture for the given authorization in the body of the request JSON. To issue this request, an original payment call must specify an intent of order.
     *
    ...
    /**
     * Authorize an order by passing the order_id in the request URI. In addition, require_once an amount object in the body of the request JSON.
     *
