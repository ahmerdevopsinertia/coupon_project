...
function edit_profile_form() {
    ...
    <span>Note:* max width: 600px, max height: 600px.</span></div></div>';
    ...
    if( $_SERVER['REQUEST_METHOD'] == 'POST' || ( isset( $_GET['code'] ) && !isset( $_GET['set_unused'] ) ) ) {
        ...
        if( isset( $_POST['code'] ) ) {
         ...
         try {
            ...
            \user\main::check_coupon_code( $code );
            ...
            $form .= '<div class="button-info"><a href="' . get_update( array( 'code' => $code, 'set_unused' => true ) ) . '" class="butt">' . t( 'check_coupon_unused_button', 'Set as "Unused".' ) . '</a></div>';
...
function submit_coupon_form( $auto_select = array( 'store' => '' ) ) {
    ...
    <input type="file" name="data_source" id="data_source" value="" /></div></div>';
...
function edit_coupon_form( $id ) {
    ...
    $source .= '<input type="file" name="data_source" id="data_source" value="" /></div></div>';
...
function edit_store_form( $id, $extra = array() ) {
    ...
    if( !$store->is_physical ) {
        ...
        if( isset( $extra['LOCATION_ADD_LINK'] ) ) $locations .= '<div><a href="' . $extra['LOCATION_ADD_LINK'] . '">' . t( 'add', "Add" ) . '</a></div>';
    ...
    $hours = array( '01:00', '01:15', '01:30', '01:45', '02:00', '02:15', '02:30', '02:45', '03:00', '03:15', '03:30', '03:45', '04:00', '04:15', '04:30', '04:45',
                  '05:00', '05:15', '05:30', '05:45', '06:00', '06:15', '06:30', '06:45', '07:00', '07:15', '07:30', '07:45', '08:00', '08:15', '08:30', '08:45',
                  '09:00', '09:15', '09:30', '09:45', '10:00', '10:15', '10:30', '11:45', '12:00', '12:15', '12:30', '12:45', '13:00', '13:15', '13:30', '13:45',
...
function edit_store_location_form( $id ) {
    ...
    deflat = parseFloat( $("input[data-marker]").attr("data-lat") );
    deflng = parseFloat( $("input[data-marker]").attr("data-lng") );
