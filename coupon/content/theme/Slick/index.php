...
<div class="bgGray hero-search pt-75 pb-75 clearfix" id="subscribe_form">
                    <div class="container"><h2 class="text-center mb-0">Don't miss anything !</h2><div class="search-form-container mt-50"><div class="subscribe_form other_form"><div class="success">You had been successfully subscribed, thank you!</div><form method="POST" action="#subscribe_form">
